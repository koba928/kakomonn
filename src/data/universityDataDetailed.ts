...
export const getUniversitiesWithDeviationAbove = (minDeviation = 55): University[] => {
...
export const getFacultiesWithDeviationAbove = (universityId: string, minDeviation = 55): Faculty[] => {
