    ...
    faculties: [
      {
        ...
        deviationValue: 72,
        departments: [
          { id: 'todai-law-general', name: '法学総合コース（第1類）' },
          { id: 'todai-law-professional', name: '法律プロフェッション・コース（第2類）' },
          { id: 'todai-law-politics', name: '政治コース（第3類）' },
          { id: 'todai-law-undecided', name: '学科未定' }
        ]
      },
      {
        id: 'todai-economics',
        ...
        departments: [
          ...
          { id: 'todai-econ-finance', name: '金融学科' },
          { id: 'todai-econ-undecided', name: '学科未定' }
        ]
      },
      {
        id: 'todai-literature',
        ...
        deviationValue: 69,
        departments: [
          { id: 'todai-lit-humanities', name: '人文学科' },
          { id: 'todai-lit-undecided', name: '学科未定' }
        ]
      },
      {
        id: 'todai-education',
        ...
        deviationValue: 66,
        departments: [
          { id: 'todai-edu-comprehensive', name: '総合教育科学科' },
          { id: 'todai-edu-undecided', name: '学科未定' }
        ]
      },
      {
        id: 'todai-science',
        ...
        departments: [
          ...
          { id: 'todai-sci-info', name: '情報科学科' },
          { id: 'todai-sci-physics', name: '物理学科' },
          { id: 'todai-sci-astronomy', name: '天文学科' },
          { id: 'todai-sci-earth', name: '地球惑星物理学科' },
          { id: 'todai-sci-geography', name: '地球惑星環境学科' },
          { id: 'todai-sci-chemistry', name: '化学科' },
          { id: 'todai-sci-biology', name: '生物学科' },
          { id: 'todai-sci-bioinformatics', name: '生物情報科学科' },
          { id: 'todai-sci-undecided', name: '学科未定' }
        ]
      },
      {
        ...
        deviationValue: 67,
        departments: [
          { id: 'todai-eng-civil', name: '社会基盤学科' },
          { id: 'todai-eng-architecture', name: '建築学科' },
          { id: 'todai-eng-urban', name: '都市工学科' },
          { id: 'todai-eng-mechanical', name: '機械工学科' },
          { id: 'todai-eng-mech-info', name: '機械情報工学科' },
          { id: 'todai-eng-aerospace', name: '航空宇宙工学科' },
          { id: 'todai-eng-precision', name: '精密工学科' },
          { id: 'todai-eng-eecs', name: '電子情報工学科' },
          { id: 'todai-eng-electrical', name: '電気電子工学科' },
          { id: 'todai-eng-physics', name: '物理工学科' },
          { id: 'todai-eng-mathematical', name: '計数工学科' },
          { id: 'todai-eng-materials', name: 'マテリアル工学科' },
          { id: 'todai-eng-applied-chem', name: '応用化学科' },
          { id: 'todai-eng-chem-system', name: '化学システム工学科' },
          { id: 'todai-eng-chem-biotech', name: '化学生命工学科' },
          { id: 'todai-eng-systems', name: 'システム創成学科' },
          { id: 'todai-eng-undecided', name: '学科未定' }
        ]
      },
      {
        id: 'todai-medicine',
        ...
        departments: [
          ...
          { id: 'todai-med-health', name: '健康総合科学科' },
          { id: 'todai-med-undecided', name: '学科未定' }
        ]
      },
      {
        id: 'todai-pharmacy',
        ...
        deviationValue: 68,
        departments: [
          { id: 'todai-pharm-pharmacy', name: '薬学科（6年制）' },
          { id: 'todai-pharm-pharmaceutical', name: '薬科学科（4年制）' },
          { id: 'todai-pharm-undecided', name: '学科未定' }
        ]
      },
      {
        ...
        deviationValue: 65,
        departments: [
          { id: 'todai-agri-applied-life', name: '応用生命科学課程' },
          { id: 'todai-agri-environment', name: '環境資源科学課程' },
          { id: 'todai-agri-veterinary', name: '獣医学課程' },
          { id: 'todai-agri-undecided', name: '学科未定' }
        ]
      },
      {
        id: 'todai-liberal-arts',
        name: '教養学部（後期課程）',
        deviationValue: 66,
        departments: [
          { id: 'todai-liberal-general', name: '教養学科' },
          { id: 'todai-liberal-interdisciplinary', name: '学際科学科' },
          { id: 'todai-liberal-integrated', name: '統合自然科学科' },
          { id: 'todai-liberal-undecided', name: '学科未定' }
        ]
      }
    ]
  },
